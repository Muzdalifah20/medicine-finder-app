...
export default function Navbar() {
  return (
    <header className="header relative z-50 bg-gray-900/95 backdrop-blur-sm border-b border-gray-800/50 sticky top-0">
      <div className="wrapper max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="header__nav flex flex-wrap items-center justify-center md:justify-between text-center md:text-left gap-5 md:gap-8 lg:gap-10 py-4 md:py-6">
          {/* MedicineFinder Logo - Full width mobile, auto desktop */}
          <Link
            to="/"
            className="header__home font-black text-2xl md:text-3xl lg:text-4xl leading-none text-white no-underline flex-1 md:flex-none md:mr-auto hover:text-blue-400 transition-all duration-300 flex items-center gap-2"
          >
            💊 MedicineFinder
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-6 lg:gap-8 w-full md:w-auto">
            {/* Main Navigation Links */}
            <div className="flex-1 md:flex-none md:order-1 w-full md:w-auto">
              <div className="hidden md:flex items-center justify-center md:justify-start gap-6 lg:gap-8">
                <Link
                  to="/favorites"
                  className="text-white/80 hover:text-white font-medium px-4 py-2 rounded-xl hover:bg-white/10 transition-all duration-300"
                >
                  Favorites
                </Link>
                <Link
              ...
              <div className="md:hidden w-full py-2">
                <div className="flex flex-col space-y-2 bg-white/5 backdrop-blur-sm rounded-xl p-4">
                  <Link
                    to="/favorites"
                    className="text-white/90 hover:text-white py-2 px-4 rounded-lg hover:bg-white/20 transition-all duration-300 block"
                  >
                    Favorites
                  </Link>
                  <Link
            ...
            <div className="flex items-center gap-2 md:gap-3 order-2 md:order-2">
              <Link
