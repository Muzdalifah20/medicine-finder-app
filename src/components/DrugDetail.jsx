...
export default function DrugDetail() {
  ...
  if (error || !drugInfo) {
    return (
      <div className="max-[420px]:w-sm min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 pb-20">
      ...
      <div className="max-[420px]:w-sm max-w-4xl mx-auto px-6">
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden mb-12 border border-white/50 p-8 md:p-12 lg:p-16 text-center">
          ...
          <h1 className="break-words text-3xl md:text-5xl  lg:text-6xl tracking-tighter font-black bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 bg-clip-text text-transparent mb-6 leading-tight">
            {drugInfo.name}
          </h1>
        </div>
